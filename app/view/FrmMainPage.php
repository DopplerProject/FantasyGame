        ...
        <div class="layout-container">
            ...
            <div class="container-xxl container-p-y">
                <div class="misc-wrapper">
                    <h2 class="mb-2 mx-2">Em Manutenção!</h2>
                    <p class="mb-4 mx-2">Pedimos desculpas pelo inconveniente, estamos realizando algumas manutenções nessa página no momento</p>
                    <a href="../view/FrmLogin.php?msg=null" class="btn btn-primary">Voltar ao Login</a>
                    <div class="mt-4">
                        <img src="../../product/template/img/illustrations/girl-doing-yoga-light.png" alt="girl-doing-yoga-light" width="500" class="img-fluid" data-app-dark-img="illustrations/girl-doing-yoga-dark.png" data-app-light-img="illustrations/girl-doing-yoga-light.png" />
                    </div>
                </div>
            </div>
            ...
            <a href="../view/FrmLineup.php?cd=<?php echo ($_GET["cd"]) . '&  msg=null' ?>">
                ESCALAR JOGADORES
            </a>
             -->
        </div>
